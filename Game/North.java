...
public abstract class North extends House {
    /**
     * Declare a north object by calling the super constructor.
     * @param xPos   Position of x
     * @param yPos   Position of y
     * @param symbol Rectangle image
     */
    public North(int xPos, int yPos, Rectangle symbol) {
    ...
    public void move() {
        ...
        age++; //age increment
        if (yPos < 300) {
            health++; //advantage for roaming in the north
        }
